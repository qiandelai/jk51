...
<script language="JavaScript">
	...
	$(function(){
		...
		var url = "${ctx}/cargo/exportAction_getExpoerProductByExportId";
		var params = {"id":"${id}"};
		$.post(url,params,function(data){
			$.each(data,function(){
				//alert(typeof(this.grossWeight));
				addTRRecord("mRecordTable",delUndefined(this.exportProductId), delUndefined(this.productNo), delUndefined(this.cnumber)
						, delUndefined(this.grossWeight), delUndefined(this.netWeight), delUndefined(this.sizeLength), 
						delUndefined(this.sizeWidth), delUndefined(this.sizeHeight), delUndefined(this.exPrice), delUndefined(this.tax));
			})
		},"json");
    });
