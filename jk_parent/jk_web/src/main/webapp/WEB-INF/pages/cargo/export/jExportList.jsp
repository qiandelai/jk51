		...
		<tr>
			<td>
				<form id="paramsSelect" method="post" >
					 	收货人及地址:<input type="text" name="consignee" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;
					 	运输方式:<input type="text" name="transportMode" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;
					 	...
					 	&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" onclick="formSubmit('exportAction_paramsSelect2','_self');this.blur();" value="提交查询"/>
				</form>
			</td>
		</tr>
	</table>
