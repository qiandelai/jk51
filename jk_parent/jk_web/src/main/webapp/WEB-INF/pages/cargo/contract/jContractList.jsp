		...
		<tr>
			<td>
				<form id="paramsSelect" method="post" >
					 	客户名称:<input type="text" name="khName" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;
					 	合同号:<input type="text" name="htNo" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;
					 	交货期限:<input type="text" style="width:90px;" name="jhTime" value="" onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});"/>
					 	&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" onclick="formSubmit('contractAction_paramsSelect','_self');this.blur();" value="提交查询"/>
				</form>
			</td>
		</tr>
	</table>
