	   ...
	   <div class="panel">
	       ...
	       <div class="panel-header">
	        ...
	        <div class="panel-content">
				<ul>
					<li><a href="${ctx}/board/boardAction_list" target="main" id="aa_3" onclick="linkHighlighted(this)">我的留言板</a></li>
					<li><a href="${ctx}/home/workflow/tasklist.action" target="main" id="aa_2" onclick="linkHighlighted(this)">我的代办任务</a></li>
					<li><a href="${ctx}/cargo/feedbackAction_list" target="main" id="aa_1" onclick="linkHighlighted(this)">意见反馈</a></li>
				</ul>
	        </div>
		...
		<div class="sidebar_t_r"></div>
 	    ...
 	    <div class="panel">
	        ...
	        <div style="border-bottom:1px dotted #cee1df;"> 
	         切换:<a href="#" >快捷菜单</a><!-- onmousemove="javascript:showMenu('fastMenu');" -->
	        /
	        <a href="#" >自定义菜单</a><!-- onmousemove="javascript:showMenu('customerMenu');" -->
	        <div class="panel-content">
	        <ul>
		        		<c:forEach items="${mlist }" var="m">
<%-- 		        		${m.key.split('1234')[0] } --%>
<%-- 		        		${m.key.split('1234')[1] } --%>
<li><a href="${ctx}/${m.key.split('1234')[0] }" onclick="linkHighlighted(this)" target="main" id="aa_1">${m.key.split('1234')[1] }(${m.value })</a></li>
		        		</c:forEach>
		        		</ul>
	        </div>
		        	<div id="fastMenu">
		        	...
		        	</div><a href="${ctx }/homeAction_DelFastMenu" class="DelFastMenu"><font color="gray">清除常用功能列表</font></a>
		        	</div>
...
<div id="sidebar" class="sidebar">
    ...
    <div class="panel">
        ...
        <div class="panel-content">
			<ul>
				<li><a target="main" href="${ctx }/sysadmin/userAction_toverify.action" id="aa_2" onclick="linkHighlighted(this)">个人信息修改</a></li>						
